...
def train(model,
    ...
    for epoch in range(n_epoch):
        ...
        train_loss, train_acc = one_train(
            model, train_iterator, optimizer, criterion, accuracy_function=accuracy_function)

        valid_loss, valid_acc = evaluate(
            model, valid_iterator, criterion, accuracy_function=accuracy_function)
